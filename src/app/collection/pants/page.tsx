  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Transform products to match our interface and filter for pants only
        const transformedProducts = allProducts
          ...
          .filter((product: Product) => {
            ...
            // Filter for pants
            return productType.includes('pant') || 
        ...
        console.log(`Successfully fetched ${transformedProducts.length} pants products from Shopify`);
      } catch (err) {
      ...
      <div className="container mx-auto px-4 mb-12">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-[#5c5c52] mb-8">
            Discover our meticulously crafted pants, designed with premium fabrics and impeccable attention to detail.
          </p>
        </div>
      </div>
      ...
      <div className="relative h-[300px] mb-16 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#2c2c27] bg-opacity-30 flex items-center justify-center">
          <div className="text-center text-white">
            <h2 className="text-3xl font-serif font-bold mb-4">Distinguished Pants</h2>
            <p className="text-lg max-w-xl mx-auto">Precision cut for refined comfort</p>
          </div>
        </div>
      </div>
