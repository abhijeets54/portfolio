...
const projects = [
  ...
  },
  {
    ...
    description: 'A fashion AI assistant that generates personalized outfit recommendations based on user responses, leveraging AI-generated questions for better styling accuracy.',
    image: '/ootd.png',
